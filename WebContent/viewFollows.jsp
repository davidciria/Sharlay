...
<c:forEach var="u" items="${users}">       
 <div id="${u.uid}" class="sU w3-container w3-card w3-white w3-round w3-margin w3-animate-opacity"><br>
	 <c:if test="${mainUser}">
	   ...
	   <h4 style="text-decoration:none" onmouseover="style='text-decoration:underline; cursor:pointer'" onmouseout="style='text-decoration:none'"> ${u.username} <button type="button" class="uF w3-button w3-right w3-red w3-margin-bottom"><i class="fa fa-minus-circle"></i> &nbsp;Unfollow</button> </h4>
	 </c:if>
	 <c:if test="${!mainUser}">
