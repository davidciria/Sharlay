...
<div class="w3-row">
  	<div class="w3-container w3-card w3-text w3-round w3-margin w3-animate-opacity w3-col m4 w3-center">
	  	<div >
	  		...
	  		<p><b class="imp-text w3-large">Sharlay, Share & Play</b></p>
	  	</div>
	</div> 
	<div  class="w3-container w3-card w3-text w3-round w3-margin w3-animate-opacity w3-col m7 w3-center">
	  	  	<p>Join <b class="imp-text">Sharlay</b>, where you can share everything about your games.</p>
	  	  	<p>Start sharing with <b class="imp-text">Sharlay</b>:</p>
	  	  	...
	  	  	<p>People are already enjoying <b class="imp-text">Sharlay</b>, take a look!</p>
