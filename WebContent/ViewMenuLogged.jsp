...
<div class="w3-bar w3-purple">
	...
	<a class="vFTl w3-bar-item w3-button w3-hide-small" id="GlTimeline" href=#>Personalized <i class="fa fa-globe w3-large" aria-hidden="true"></i> </a>
	<a class="w3-hide-medium w3-hide-small"><img src="img/logo_fusion_cut.png" class="w3-circle" style="height:35px; width:35px; margin-top: 0%; margin-left: 50%" alt="Sharlay's logo"></a>
